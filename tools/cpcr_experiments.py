"""Canonical CPCR-YOLOv13 L1--L5 ablation definitions and L4 analysis criteria."""
...
FINAL_STAGE = "l5"
ALL_STAGES = (*STAGE_ORDER, FINAL_STAGE)
MODEL_FILES = {
...
STRUCTURES = {
    ...
    "l5": {"backbone": "SCPG-H3 at layer 4", "head": "full CPCRDetect", "purpose": "direct H3 interaction experiment after L4"},
}
