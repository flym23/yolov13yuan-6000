#!/usr/bin/env python3
"""Train exactly one deterministic SBT T1--T7 seed with the fixed experiment protocol."""
...
from sbt_experiments import MODEL_FILES, STRUCTURES, resolve_model  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stage", choices=tuple(stage for stage in MODEL_FILES if stage != "t0"), required=True)
