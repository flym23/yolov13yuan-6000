#!/usr/bin/env python3
"""Train one SCPG H1--H5 stage for one deterministic URPC2020half seed."""
...
# Disable pinned-memory transport before importing Ultralytics to avoid prior pin-memory worker resets.
os.environ["PIN_MEMORY"] = "false"

from scpg_experiments import MODEL_FILES, STRUCTURES, resolve_model  # noqa: E402
