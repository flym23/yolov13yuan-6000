#!/usr/bin/env python3
"""Aggregate completed GMR test summaries while retaining the two reused R0 baselines."""
...
from tools.gmr_experiments import REFERENCE_SUMMARIES, SEEDS, STRUCTURES, TRAIN_STAGES  # noqa: E402
...
def main() -> None:
    ...
    summary: dict[str, object] = {
        ...
        "r0_reused_baselines": read_references(),
