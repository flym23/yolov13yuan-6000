#!/usr/bin/env bash
# Run DGDR G1..G7 only after the ME-DCRA M0--M7 launcher finishes successfully.
set -Eeuo pipefail
...
d = {
    ...
    "stage_order": ["g1", "g2", "g3", "g4", "g5", "g6", "g7"],
...
echo "DGDR G1--G7 chain completed: run_id=$RUN_ID"
