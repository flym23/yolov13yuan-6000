...
class UDQDetect(Detect):
    ...
    def _quality_logits(self, feature, box_logits, level_index):
        ...
        strength = self.stat_strengths[level_index].to(device=feature.device, dtype=feature.dtype)
        return self.cvq[level_index](feature) + strength * self.cvq_stat[level_index](statistics)
