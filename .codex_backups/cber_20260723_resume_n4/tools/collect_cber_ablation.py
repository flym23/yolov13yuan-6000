...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--check-n4", action="store_true", help="Record the N4 research gate without blocking N5/N6 continuation.")
...
def main() -> None:
    ...
    if args.check_n4:
        ...
        print("N4 gate recorded; N5/N6 continuation is unconditional.")
