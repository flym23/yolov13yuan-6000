#!/usr/bin/env python3
"""Atomically write the compact state record for the CARM training chain."""
...
def main() -> None:
    ...
    parser.add_argument("--l3cru-state", required=True)
    ...
    payload = {
        ...
        "dependency": {"l3cru_state": args.l3cru_state, "initialization_weights": args.pretrained},
